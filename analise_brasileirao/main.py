...
if __name__ == "__main__":
    # As métricas estão na função choose_time()
    time1 = input("Informe o primeiro time do brasileirao: ")
    time2 = input("Informe o segundo time do brasileirao: ")
    print(build_chart('goalsScored', time1, time2))